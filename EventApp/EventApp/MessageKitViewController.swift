...
//  Created by Reka Vihari on 2018. 10. 27..
...
final class MessageKitViewController: ChatViewController {
    ...
    private func configureInputBarItems() {
        ...
        let charCountButton = InputBarButtonItem()
            .configure {
                ...
                $0.setTitleColor(UIColor(red: CGFloat(127/255.0), green: CGFloat(198/255.0), blue: CGFloat(226/255.0), alpha: CGFloat(1.0)), for: .normal)
                ...
                let color = isOverLimit ? .red : UIColor(red: CGFloat(127/255.0), green: CGFloat(198/255.0), blue: CGFloat(226/255.0), alpha: CGFloat(1.0))
    ...
    override func messageBottomLabelAttributedText(for message: MessageType, at indexPath: IndexPath) -> NSAttributedString? {
        ...
        if !isNextMessageSameSender(at: indexPath) && isFromCurrentSender(message: message) {
            return NSAttributedString(string: "Kézbesítve", attributes: [NSAttributedString.Key.font: UIFont.preferredFont(forTextStyle: .caption1)])
        }
        return nil
    }
